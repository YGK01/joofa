...
$Cate_ID=$_GET["id"];
$result = mysqli_query($con,"SELECT * FROM category WHERE categoryID = '$Cate_ID'");
...
if(isset($_POST['update'])){
    ...
    $update = "    UPDATE `category` SET`category`='$CName',`categoryStatus`='$Cstatus' WHERE `categoryID`='$Cate_ID'";
...
<head>
    <title>Joo Fa Trading - Edit Categpry Page</title>
    <meta charset="utf-8">
            ...
            <section class="bg-light">
                <div class="container pb-5">
                    ...
                    <div class="left">
                        ...
                        <input type="text" name="cate_name" value="<?php echo $row['category'] ?>" />
                    </div>
