...
if (isset($_GET["page"])) {
    ...
    $get = "SELECT * FROM courier ORDER BY CourierID ASC LIMIT $start_from, $limit";
...
if(isset($_POST['upload'])){
    ...
    $cName = $_POST['cou_name'];
    $cPrice = $_POST['cou_price'];
    $cPrice2 = $_POST['cou_price2'];
    ...
    $get1 = "SELECT * FROM courier WHERE CourierName = '$cName'" ;
    ...
    if($count>=1){
        echo '<script>alert("Courier Name is Duplicated")</script>';
    }
    else{

        $insert = "INSERT INTO courier VALUES (null, '". $cName ."', '". $cPrice ."', '". $cPrice2 ."', '". $cStatus ."')";
...
<header>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class=row>
            <section class="bg-light">
                <div class="container pb-5">
                    ...
                    <div class="left">
                        ...
                        <input type="text" name="cou_name" placeholder="Courier Name" />
                    </div>

                    <div class="left">
                        <label>Price(For First 500g)</label>
                        <input type="text" name="cou_price" placeholder="RM XX.XX" />
                    </div>

                    <div class="left">
                        <label>Price(After 500g)</label>
                        <input type="text" name="cou_price2" placeholder="RM XX.XX" />
                    </div>
                    ...
                    <table class="table caption-top">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>RM<?php echo $row["CourierPrice"] ?></td>
                                <td><?php echo $row["Status"] ?></td>
                                <td><a href="A_CourierEdit.php?id=<?php echo $row["CourierID"]?>"
            ...
            $query = mysqli_query($con,"SELECT COUNT(CourierID) FROM courier");
